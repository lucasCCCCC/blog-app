        ...
        <form className="settingsForm" onSubmit={handleSubmit}>
          ...
          <div className="settingsProfilePicture">
            <img src={file ? URL.createObjectURL(file) :
               PUBLIC_FOLDER+user.profilePicture} alt="">
          ...
          <button className="settingsSubmit" type="submit">Update Profile</button>
          
          {success && <span style={{color:"green", textAlign: "center", marginTop: "20px"}}>Profile updated succesfully !</span>}
